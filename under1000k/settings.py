"""
Django settings for under1000k project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-rddi%yt4k%(mq_+x@$me398xhajve13f7tba+2ovlb)0&5p0t&')
...
WSGI_APPLICATION = 'under1000k.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'under1000k.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
